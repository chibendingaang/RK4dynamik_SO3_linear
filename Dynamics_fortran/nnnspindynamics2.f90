...
!something's wrong here;? rectify it
    ...
    do xi = 1, L
        ...
        k2(3*xi-2) = (sx_2 + 0.5*k1_2) * (a*(sxrght_3 + 0.5*k1rght_3 + sxrrghtt_3 + 0.5*k1rrghtt_3) & 
                                        + b*(sxleft_3 + 0.5*k1Left_3 + sxlleftt_3 + 0.5*k1lleftt_3))   &
                    -(sx_3 + 0.5*k1_3) * (a*(sxrght_2 + 0.5*k1rght_2 + sxrrghtt_2 + 0.5*k1rrghtt_2) & 
                                         +b*(sxleft_2 + 0.5*k1left_2 + sxlleftt_2 + 0.5*k1lleftt_2)) 

        k2(3*xi-1) = (sx_3 + 0.5*k1_3) * (a*(sxrght_1 + 0.5*k1rght_1 + sxrrghtt_1 + 0.5*k1rrghtt_1) & 
                                        + b*(sxleft_1 + 0.5*k1left_1 + sxlleftt_1 + 0.5*k1lleftt_1))   &
                    -(sx_1 + 0.5*k1_1) * (a*(sxrght_3 + 0.5*k1rght_3 + sxrrghtt_3 + 0.5*k1rrghtt_3)  & 
                                        + b*(sxleft_3 + 0.5*k1left_3 + sxlleftt_3 + 0.5*k1lleftt_3))

        k2(3*xi) = (sx_1 + 0.5*k1_1) * (a*(sxrght_2 + 0.5*k1rght_2 + sxrrghtt_2 + 0.5*k1rrghtt_2) & 
                                      + b*(sxleft_2 + 0.5*k1left_2 + sxlleftt_2 + 0.5*k1lleftt_2))    &
                  -(sx_2 + 0.5*k1_2) * (a*(sxrght_1 + 0.5*k1rght_1 + sxrrghtt_1 + 0.5*k1rrghtt_1) 
                                      + b*(sxleft_1 + 0.5*k1left_1 + sxlleftt_1 + 0.5*k1lleftt_1)) 
    end do
    ...
    do xi = 1, L
        ...
        k3(3*xi-2) = (sx_2 + 0.5*k2_2) * (a*(sxrght_3 + 0.5*k2rght_3 + sxrrghtt_3 + 0.5*k2rrghtt_3) & 
                                        + b*(sxleft_3 + 0.5*k2Left_3 + sxlleftt_3 + 0.5*k2lleftt_3))   &
                    -(sx_3 + 0.5*k2_3) * (a*(sxrght_2 + 0.5*k2rght_2 + sxrrghtt_2 + 0.5*k2rrghtt_2) & 
                                         +b*(sxleft_2 + 0.5*k2left_2 + sxlleftt_2 + 0.5*k2lleftt_2)) 

        k3(3*xi-1) = (sx_3 + 0.5*k2_3) * (a*(sxrght_1 + 0.5*k2rght_1 + sxrrghtt_1 + 0.5*k2rrghtt_1) & 
                                        + b*(sxleft_1 + 0.5*k2left_1 + sxlleftt_1 + 0.5*k2lleftt_1))   &
                    -(sx_1 + 0.5*k2_1) * (a*(sxrght_3 + 0.5*k2rght_3 + sxrrghtt_3 + 0.5*k2rrghtt_3)  & 
                                        + b*(sxleft_3 + 0.5*k2left_3 + sxlleftt_3 + 0.5*k2lleftt_3))

        k3(3*xi) = (sx_1 + 0.5*k2_1) * (a*(sxrght_2 + 0.5*k2rght_2 + sxrrghtt_2 + 0.5*k2rrghtt_2) & 
                                      + b*(sxleft_2 + 0.5*k2left_2 + sxlleftt_2 + 0.5*k2lleftt_2))    &
                  -(sx_2 + 0.5*k2_2) * (a*(sxrght_1 + 0.5*k2rght_1 + sxrrghtt_1 + 0.5*k2rrghtt_1) 
                                      + b*(sxleft_1 + 0.5*k2left_1 + sxlleftt_1 + 0.5*k2lleftt_1)) 
    end do     
    ...
    do xi = 1, L  
        ...
        k4(3*xi-2) = (sx_2 + k3_2) * (a*(sxrght_3 + k3rght_3 + sxrrghtt_3 + k3rrghtt_3) & 
                                    + b*(sxleft_3 + k3Left_3 + sxlleftt_3 + k3lleftt_3))   &
                    -(sx_3 + k3_3) * (a*(sxrght_2 + k3rght_2 + sxrrghtt_2 + k3rrghtt_2) & 
                                    + b*(sxleft_2 + k3left_2 + sxlleftt_2 + k3lleftt_2)) 

        k4(3*xi-1) = (sx_3 + k3_3) * (a*(sxrght_1 + k3rght_1 + sxrrghtt_1 + k3rrghtt_1) & 
                                    + b*(sxleft_1 + k3left_1 + sxlleftt_1 + k3lleftt_1))   &
                    -(sx_1 + k3_1) * (a*(sxrght_3 + k3rght_3 + sxrrghtt_3 + k3rrghtt_3)  & 
                                    + b*(sxleft_3 + k3left_3 + sxlleftt_3 + k3lleftt_3))

        k4(3*xi) = (sx_1 + k3_1) * (a*(sxrght_2 +  k3rght_2 + sxrrghtt_2 + k3rrghtt_2) & 
                                  + b*(sxleft_2 + k3left_2 + sxlleftt_2 + k3lleftt_2))    &
                  -(sx_2 + k3_2) * (a*(sxrght_1 + k3rght_1 + sxrrghtt_1 + k3rrghtt_1) 
                                  + b*(sxleft_1 + k3left_1 + sxlleftt_1 + k3lleftt_1)) 
    end do        
