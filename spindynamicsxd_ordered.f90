...
do xi=1,L
    ...
    spin(3*xi-2) = eps*sin(phi(xi)) !*cos(theta(xi))
    spin(3*xi-1) = eps*cos(phi(xi)) !sin(phi(xi))*sin(theta(xi)) !0.0_xd 
    spin(3*xi)   = 1.0_xd           !sqrt(1-(spin(3*xi-2))**2); 
...
End module spindynamicsxd_ordered
